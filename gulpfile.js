...
// Project related.
// var project               = 'arity'; // Project Name, all lowercase, no spaces
var projectURL               = 'arity.work'; // Project URL. Could be something like development.work
...
// JS Vendor related.
var jsVendorSRC              = './src/js/plugins/*.js';
...
// Fonts relate.
var fontsSRC                 = './src/webfonts/**/*.{eot,woff,woff2,otf,svg,ttf}'; // Source folder of images which should be optimized.
var fontsDestination         = './dist/webfonts/'; // Destination folder of optimized images. Must be different from the imagesSRC folder.

// Watch files paths.
var styleWatchFiles          = './src/sass/**/*.scss'; // Path to all *.scss files inside css folder and inside them.
var vendorJSWatchFiles       = './src/js/plugins/*.js'; // Path to all vendor JS files.
var customJSWatchFiles       = './src/js/*.js'; // Path to all custom JS files.
var projectPHPWatchFiles     = './**/*.php'; // Path to all PHP files.
var imagesWatchFiles         = './src/img/**/*.{png,jpg,jpeg,gif,svg}';
...
gulp.task('watch:files', function() {
    gulp.watch(projectPHPWatchFiles).on('change', gulp.series(reload)); // Reload on PHP file changes.
